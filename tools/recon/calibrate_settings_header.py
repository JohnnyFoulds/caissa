...
"""Find Settings header by going straight up from x=255, 260, 265, 270, 280."""
...
def try_x(driver, x):
    driver._move_to_amiga(x, _START_Y)
    time.sleep(0.3)
